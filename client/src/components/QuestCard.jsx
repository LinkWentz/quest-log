...
function QuestCard(props) {
    ...
    return (
        <div key={props.key + ' completed: ' + content.completed} className={`QuestCard Interactable ${props.selected ? 'Selected' : ''} ${content.completed == true ? 'Complete' : ''} ${content.completed == false ? 'Defeat' : ''}`}>
